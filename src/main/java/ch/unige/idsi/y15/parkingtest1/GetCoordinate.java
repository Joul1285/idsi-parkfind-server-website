...
public class GetCoordinate extends HttpServlet {
	...
	protected void doGet(HttpServletRequest request,
		...
		System.out.println(Arrays.toString(gps2m(getLatitude, getLongitude, parkingList)));
		String[] result_shortest = gps2m(getLatitude, getLongitude, parkingList);
		System.out.println(result_shortest[0]);
	 ...
	 * @return
	 */
	private static String[] gps2m(double lat_origin, double lng_origin, List<ParkingHandi> parkingList) {
		...
		Iterator iterator = parkingList.iterator();
