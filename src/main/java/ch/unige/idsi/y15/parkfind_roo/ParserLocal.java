...
* @since   2015-05-20 
*/
public class ParserLocal extends HttpServlet {
	...
	protected void doGet(HttpServletRequest request,
		...
		URL urlHandi = new URL(
				"https://docs.google.com/uc?authuser=0&id=0B25Nyqtu53i9VGtuNWduM2FVT3M&export=download");
		getKMZ(urlHandi, "Handi");

		URL urlPublique = new URL(
				"https://docs.google.com/uc?authuser=0&id=0B25Nyqtu53i9bEUya0ZDOU16MGc&export=download");
		getKMZ(urlPublique, "Publique");

		URL urlVoie = new URL(
				"https://docs.google.com/uc?authuser=0&id=0B25Nyqtu53i9U1RqZVFWVkNwNGs&export=download");
		getKMZ(urlVoie, "Voie");
	...
	public static void getKMZ(URL u, String type) throws IOException {
		System.out.println("start getkmz");
		URLConnection uc = u.openConnection();
		
		
		System.out.println("start getkmz2");
		uc.connect();
		
		System.out.println("start getkmz3");
		InputStream in = uc.getInputStream();
		System.out.println("start getkmz4");
		File file = new File(type + ".kmz");
		System.out.println("start getkmz5");
